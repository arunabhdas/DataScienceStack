...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './scientist.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCIENTIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCIENTIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCIENTIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCIENTIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCIENTIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCIENTIST actions', async () => {
      const expectedActions = [
        {
